...
3. Verificar que la caché de la app web (`my-cache`) contenga el elemento `datos.json`.
    **Nota:** para hacer la prueba de caché, deberá quitar el comentario del evento `fetch` en el archivo [service.js](client/service.js).
...
- Para los pasos 3 y 8, deberá quitar el comentario del evento `fetch` en el archivo [service.js](client/service.js).
